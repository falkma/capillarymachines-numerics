%script for computing trajectory of floats in the reverse stroke of a taichi device
...
%initialize simulation with a guess of the last positions of the forward simulation
E_min_init = [-1.8845 0.0038 -0.1133 -1.4815 0.0044 -0.1131 2.1484 -0.0000 -0.0594];
...
for i = 0+(1:slice_num)
    ...
    save('taichi_reverse_sim_min.mat','float_min')
