%function for computing energy of capillary trap with specified geometry
%and channel contact angle

function E = slope_sweep_func(x,a_t,m,c,center,cap_length)
